      ...
      <div className="container px-4 md:px-6 lg:px-12 max-w-[1400px] mx-auto relative z-10 pt-24 pb-12">
          ...
          <div className="bg-[#121212] rounded-[32px] p-8 md:p-16 lg:p-20 shadow-2xl flex flex-col lg:flex-row gap-16 lg:gap-24 border border-white/5 mb-32">
            ...
            <div className="w-full lg:w-1/2 flex flex-col">
              ...
              <div className="mt-auto">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="#" className="w-12 h-12 rounded-xl bg-[#1e1e1e] border border-white/5 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#2a2a2a] transition-all duration-300">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#ec4899] to-[#f97316] text-white font-medium text-[16px] py-4 rounded-xl hover:opacity-90 transition-opacity mt-2"
                >
                  SUBMIT
                </button>
        ...
        <div className="flex flex-col items-center justify-center pt-8">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-8">
            <a href="#" className="text-[#a3a3a3] hover:text-white transition-colors text-[15px] flex items-center">
            ...
            <a href="#" className="text-[#a3a3a3] hover:text-white transition-colors text-[15px] flex items-center">
              Gallery <span className="text-[#f97316] ml-6">•</span>
            </a>
            <a href="#" className="text-[#a3a3a3] hover:text-white transition-colors text-[15px]">
              Faqs
            </a>
          </div>
          ...
          <div className="flex space-x-4 mb-20">
            <a href="#" className="w-10 h-10 rounded-lg bg-[#1e1e1e] border border-white/5 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#2a2a2a] transition-all duration-300">
