...
import './ContactSection.css'; // For the matte animation

export function ContactSection() {
  return (
    <section id="contact" className="py-24 relative overflow-hidden contact-matte-bg">
      <div className="container px-4 md:px-6 lg:px-12 max-w-[1400px] mx-auto relative z-10">
        
        <Reveal direction="up">
          <div className="bg-[#121212] rounded-[32px] p-8 md:p-16 lg:p-20 shadow-2xl flex flex-col lg:flex-row gap-16 lg:gap-24 border border-white/5">
